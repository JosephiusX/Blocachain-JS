...
const nodeAddress = uuid().split('-').json(''); // making node address
...
app.get('/mine', (req, res) => {
	const lastBlcok = bitcoin.getLastBlock();
	...
	const newBlock = bitcoin.createNewBlock(nonch, previousBlockHash, blockHash); // new block
